...
urlpatterns = [
    ...
    path('api/batch-assignments/<str:ba_id>/delete/', views.delete_batch_assignment, name='delete_batch_assignment'),
    ...
    path('onboarding/institutions/<int:pk>/toggle-status/', views.institution_toggle_status, name='institution_toggle_status'),
    path('api/status-update/<str:task_id>/', views.check_status_update_progress, name='check_status_update_progress'),
    ...
    path('onboarding/hospitals/<int:pk>/toggle-status/', views.hospital_toggle_status, name='hospital_toggle_status'),
    ...
    path('onboarding/learners/<int:pk>/toggle-status/', views.learner_toggle_status, name='learner_toggle_status'),
    path('onboarding/learners/bulk-delete/', views.learners_bulk_delete, name='learners_bulk_delete'),
    path('onboarding/learners/bulk-upload/', views.learner_bulk_upload, name='learner_bulk_upload'),
    path('onboarding/learners/active-uploads/', views.get_active_upload_sessions, name='get_active_upload_sessions'),
    path('onboarding/learners/upload-details/<str:session_key>/', views.get_upload_session_details, name='get_upload_session_details'),
